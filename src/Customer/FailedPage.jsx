...
export const FailedPage = () => {
    ...
    const checkOrder = async () => {
      try {
        const res = await api.get(
          `${import.meta.env.VITE_SERVER_URL}/customer/orders/${orderRef}?status=failed`,
  ...
  return (
    <main className="w-full h-auto p-4 flex justify-center items-center">
      <section className="mt-40 bg-[#fff9f9] shadow-lg p-6 flex flex-col gap-4 justify-center items-center w-full max-w-md rounded-lg border border-gray-200">
