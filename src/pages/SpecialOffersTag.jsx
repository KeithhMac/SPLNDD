...
export const SpecialOffersTag = () => {
    ...
    useEffect(() => {
        const fetchSpecialOffers = async () => {
            try {
                const res = await api.get("/customer/products/tags/special-offers");
    ...
    /* multi-checkbox select per option */
    ...
    return (
        <main className="min-h-screen overflow-x-hidden flex flex-col gap-[2rem]">
            ...
            >
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm max-w-md mx-auto">
                        Grab exclusive discounts on our most popular styles — limited time offers on quality and comfort.
                    </p>
                </div>
            </div>
            ...
            {loading ? (
                ...
                <>
                    <div className="mt-6 flex flex-wrap justify-center gap-8 pl-[3rem] pr-[3rem] pb-[5rem]">
                            ...
                            return (
                                <div key={variant.variant_id} className="w-[15rem] shadow-lg bg-white rounded-md overflow-hidden">
                                    <NavLink to={linkPath} className="relative group block w-full h-[15rem] overflow-hidden">
                                        ...
                                        {/* Special Offer Badge */}
                                        <div className="absolute top-2 right-2 bg-red-500 text-white text-xs font-semibold px-2 py-1 rounded shadow-md z-10">
                                            Special Offer!
                                        </div>
                                        {images[0] ? (
                                            <img
  ...
  `}
                ...
                <p className="text-center text-gray-500 mt-6">No special offers found.</p>
            )}
